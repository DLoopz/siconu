...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-10-2020 a las 21:55:01
...
INSERT INTO `asiento` (`id_asiento`, `empresa_id`, `descripcion`, `fecha`, `ajuste`) VALUES
(1, 1, 'aaa', '2020-10-08', 0),
(2, 5, 'kapo', '2020-10-07', 0);
...
(1, 1, 1, 'Caja', 5),
(2, 1, 1, 'Bancos', 5),
(3, 1, 1, 'Almacén/Mercancías', 5),
(4, 1, 1, 'Clientes', 5),
(5, 1, 1, 'Documentos por cobrar', 5),
(6, 1, 1, 'Deudores diversos', 5),
(7, 1, 1, 'Papelería y útiles', 5),
(8, 1, 1, 'Propaganda y publicidad', 5),
(9, 1, 1, 'Primas de seguros', 5),
(10, 1, 1, 'Rentas pagadas por anticipado', 5),
(11, 1, 1, 'Intereses pagados por anticipado', 5),
(12, 1, 2, 'Terrenos', 5),
(13, 1, 2, 'Edificios', 5),
(14, 1, 2, 'Mobiliario y equipo de oficina', 5),
(15, 1, 2, 'Equipo de cómputo ', 5),
(16, 1, 2, 'Equipo de transporte', 5),
(17, 1, 2, 'Equipo de reparto', 5),
(18, 1, 2, 'Gastos de constitución', 5),
(19, 1, 2, 'Gastos de instalación', 5),
(20, 1, 2, 'Depósitos en garantía', 5),
(21, 2, 1, 'Proveedores', 5),
(22, 2, 1, 'Documentos por pagar ', 5),
(23, 2, 1, 'Acreedores diversos', 5),
(24, 2, 1, 'Rentas cobradas por anticipado', 5),
(25, 2, 1, 'Intereses cobrados por anticipado', 5),
(26, 2, 2, 'Hipotecas por pagar', 5),
(27, 2, 2, 'Documentos por pagar largo plazo', 5),
(28, 3, 1, 'Capital ganado ', 5),
(29, 3, 1, 'Capital contribuido', 5),
(30, 4, 1, 'Ventas', 5),
(31, 4, 2, 'Devoluciones sobre compra', 5),
(32, 4, 3, 'Rebajas sobre compra', 5),
(33, 4, 3, 'Descuentos sobre compra', 5),
(34, 4, 4, 'Productos  financieros', 5),
(35, 4, 5, 'Otros productos/Otros ingresos', 5),
(36, 5, 1, 'Devoluciones  sobre ventas', 5),
(37, 5, 1, 'Rebajas sobre ventas', 5),
(38, 5, 1, 'Descuentos sobre venta', 5),
(39, 5, 2, 'Compras', 5),
(40, 5, 2, 'Gastos de Compra', 5),
(41, 5, 3, 'Costo de ventas', 5),
(42, 5, 4, 'Inventario inicial', 5),
(43, 5, 4, 'Inventario final', 5),
(44, 5, 5, 'Gastos de administración', 5),
(45, 5, 6, 'Gastos de venta', 5),
(46, 5, 7, 'Gastos financieros', 5),
(47, 5, 8, 'Otros gastos', 5);
...
INSERT INTO `empresa` (`id_empresa`, `usuario_id`, `nombre`, `estado`, `procedimiento`) VALUES
(1, 3, 'Mi Tiendita', 0, 1),
(2, 4, 'Dulcifiesta', 0, 1),
(3, 3, 'Ejercicio01', 0, 1),
(4, 3, 'Ejercicio02', 0, 0),
...
(1, 2, '3101', 28, 'Capital ganado ', 0, 5000, 0),
(2, 2, '2101', 21, 'Proveedores', 0, 0, 5000);
...
(2, 2, 'profesor', 'profesor', 'profesor', 'profesor-01@gmail.com', '3fc0a7acf087f549ac2b266baf94b8b1'),
(3, 3, 'Mayco Richard', 'Valverde', 'Rodríguez', '0114010011', '938db4af8906ac1e031772e61ed8c07e'),
(4, 3, 'Santiago Gilberto', 'Cortes', 'Cortes', '0114010000', '1e4a559e74a7d6e204696012cd2a2d49'),
(5, 2, 'profesor', 'profesor', 'profesor', '123@gmail.com', '25d55ad283aa400af464c76d713c07ad'),
(6, 3, 'Mayco Richard', 'Valverde', 'Rodríguez', '01140100111', 'ca8e220caefd3de581a6e2d643dc1a2f');
...
--
ALTER TABLE `catalogo_usuario`
  MODIFY `id_catalogo_usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `usuario_grupo`
  MODIFY `id_usuario_grupo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
