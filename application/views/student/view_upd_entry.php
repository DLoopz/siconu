<div class="container col-md-4" >
	<div class = "panel panel-primary col-md-offset-4">
		<div class = "panel-heading" >
			<h3 class = "panel-title">Modificar Asiento </h3>
		</div>
		<hr class="line_sep">
		...
		<?php if (isset($entry)) {?>
			<form method="post"  action="<?php echo base_url();?>daybook/edit_entry/<?php echo $id_empresa;?>/<?php echo $entry->id_asiento;?>">
				<div class="form-group">
					...
					<input type="text" name="concepto" class="form-control" placeholder="Descripcion del Asiento" value="<?php echo $entry->concepto;?>">
