  ...
  <div class="tab-content" id="nav-tabContent">
    <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list"><p class="text-light bg-dark"> 
      ...
      <div class="panel-body">
        <div class="row">
          <div class="col-lg-12">
            <a href="<?php echo base_url('admin/add_professor'); ?>"class="btn btn-outline-success" aria-label="Left Align" title="Agregar catálogo de cuentas"><i class="icon-plus-2"></i></a>
            </br>
            </br>
              ...
              <tbody>
                <?php foreach ($profesor as $row) {?>
                  <tr>
                    ...
                    <td>
                        <!-- eliminar profesor -->
                        <a class="btn btn-outline-danger" href="" data-toggle="modal" data-target="#mi_modal" onclick="eliminar(<?php echo $row->id_usuario;?>)" title="Eliminar"><strong><em><i class="icon-trash-empty"></i></em></strong></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
               <form method="POST" action="<?php echo base_url() ?>admin/eliminar_professor">
                   ...
                   <input type="reset" class="btn btn-outline-success" value="No">
